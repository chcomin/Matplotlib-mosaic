...
class PlotMosaic:
	...
	plotsData : array_like
		List of lists, each i-th sublist containing the x and y data corresponding to the i-th point in the main plot
	dragPlotter : function
		Function with arguments (x, y, ax), where x and y are the data points and ax an axis. This function is used
		for plotting the draggable axes
